<x-app-layout title="Application Details">
    <a href="{{ route('candidate.applications.index') }}" class="d-inline-flex align-items-center gap-1 text-decoration-none small fw-semibold mb-3" style="color:#005292;">
        <i class="bi bi-arrow-left"></i> Back to my applications
    </a>

    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
        <div>
            <p class="text-uppercase small fw-semibold mb-1" style="color:#44A66D;">Application for</p>
            <h2 class="h4 fw-bold mb-0">{{ $application->subject->title }}</h2>
                    ...
                    <ul class="timeline">
                        @foreach ($application->statusLogs as $log)
                            <li>
                                ...
                                <p class="small text-muted mb-1">{{ $log->created_at->format('d M Y, H:i') }}</p>
                                @if ($log->comment)
